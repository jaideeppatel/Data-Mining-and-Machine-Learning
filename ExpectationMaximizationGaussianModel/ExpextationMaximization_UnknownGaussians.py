...
if __name__ == '__main__':
    ...
    print('To Begin processing please enter the different number of gaussians (For example: 2,3,4) that you would like to test: ')
    userinput = input()
    ...
    #
    #     print('The Gaussian Parameters when number of Gaussians are '+str(i)+' for Data2 are: ')
    #     print('        mu       sigma       p(C_i)')
    #     print(parameters[0])
    #
    ...
    for i in userinput:
        ...
        print('The Gaussian Parameters when number of Gaussians are '+str(i)+' for Data3 are: ')
        print('        mu       sigma       p(C_i)')
        print(parameters[0])
        ...
        plt.ylabel('Log Likelihood')
        plt.title('Number of Iterations Versus Log Likelihood')
        plt.savefig('LL for Data3 for Gaussian - ' + str(i) + '.png')
        plt.clf()